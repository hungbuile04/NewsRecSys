...
class MINDDataset(Dataset):
    def __init__(self, behaviors_file, news_file, tokenizer, 
                 max_title_len=30, max_history_len=50, mode='train'):
        """
        Args:
    ...
    def _load_news(self, news_file):
        ...
        # Add padding news for empty history
